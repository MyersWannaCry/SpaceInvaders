...
while run:
    ...
    if not boss.solo_movement and keys[pygame.K_LEFT]:
        if player.normal_moving and player.instance.x > 0:
            player.instance.x -= player.speed
        elif not player.normal_moving and player.instance.x < 1280 - player.instance.width:
            player.instance.x += player.speed
    if not boss.solo_movement and keys[pygame.K_RIGHT]:
        if player.normal_moving and player.instance.x < 1280 - player.instance.width:
            player.instance.x += player.speed
        elif not player.normal_moving and player.instance.x > 0:
            player.instance.x -= player.speed
